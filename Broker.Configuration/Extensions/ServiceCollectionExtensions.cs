...
{
    public static IServiceCollection AddBroker<TBroker>(this IServiceCollection services, Action<BrokerOptions<TBroker>> configure) where TBroker : class, IBroker<TBroker>
    {
